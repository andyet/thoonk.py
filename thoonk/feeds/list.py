...
class List(Feed):
    ...
    """
    A Thoonk list feed is a manually ordered collection of items.
    ...
    Thoonk Standard API:
        ...
        get_all   -- Return all items in the list.
        get_ids   -- Return the IDs of all items in the list.
        get_item  -- Return a single item from the list given its ID.
        prepend   -- Add an item to the beginning of the list.
        retract   -- Remove an item from the list.
        publish   -- Add an item to the end of the list.
    ...
    def __init__(self, thoonk, feed, config=None):
        """
        Create a new List object for a given Thoonk feed.

        Note: More than one List objects may be create for the same
              Thoonk feed, and creating a List object does not
    ...
    def __insert(self, item, rel_id, method):
        """
        Insert an item into the list, either before or after an
        existing item.
    ...
    def edit(self, id, item):
        """
        Modify an item in-place in the list.
    ...
    def get_item(self, id):
        """
        Retrieve a single item from the list.
